...
- `SCALING_PLAYBOOK_ASREVIEW_CROWDSCREEN_DORY.md` — practical scale-up playbook for large corpora, including run versioning, multi-reviewer overlap/kappa, CrowdScreen, Dory, and automation risk gates.
